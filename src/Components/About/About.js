        ...
        <section className="about">
          <article className="about_article" id="about_article">
            <p className="about_article_text">
              ...
              company that can do a bit of everything. Etc... this narrative
              will need some work.
            </p>
            <img
          ...
          <article className="about_article">
            <p className="about_article_text">
              ...
              values that sit at the very core of Timberline Inc. Steve Gibson
              is a creative problem solver that will work with you to find the
